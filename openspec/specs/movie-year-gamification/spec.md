# Movie Year Gamification

## Purpose

Define the yearly movie challenge dashboard that visualizes current-year watching progress, metrics, streaks, and watched-day details.
